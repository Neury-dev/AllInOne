...
function w3CodeColor(elmnt, mode) {
    ...
    elmntObj.style.fontSize = "0.90em";
    if (!lang) {
        lang = "html";
    }
    if (lang == "html") {
    ...
    function htmlMode(txt) {
        ...
        while (rest.indexOf("&lt;") > -1) {
            ...
            if (rest.substr(startpos, 8).toUpperCase() == "&LT;?php") {
                note = "php";
            }
            /* start agregado*/
            ...
            /* Falta la función phpMode xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx*/
            if (note == "php") {
                endpos = rest.indexOf("&lt;?&gt;");
                if (endpos > -1) {
                    //done += jsMode(rest.substring(0, endpos));
                    done += phpMode(rest.substring(0, endpos));
                    rest = rest.substr(endpos);
                }
