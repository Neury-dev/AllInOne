    ...
    <main>
        ...
        <h3>Lenguajes y Herramientas</h3>
            ...
            <h4>Backend developer</h4>
                <p>PHP, JavaScript, Java, SQL, JSON, NoSQL...</p>
...
<section class="area-3">
    ...
    <h3>¡Con 
        <span class="iconos">
            ...
            <i class='fab fa-js-square icono' title="JavaScript"></i>
            <i class='fab fa-php icono' title="PHP"></i>
            <i class='fab fa-node icono' title="Nodejs"></i>
        </span> 
        se hace!
    </h3>
    <article>
