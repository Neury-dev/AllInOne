...
//var jsonObject;
var id, marca, nombre, precio, enviar, buscar, cantidad; 
...
cantidad  = document.querySelector("#mas-form");
//leer();
function 
leer(busqueda) {
...
buscar.addEventListener("keyup", function() {
    buscar = document.forms["buscar"]["buscar"].value;//const valor = buscar.value;
...
////        var articles = jsonObject;
//        
//        
//    for (let i in jsonObject) {
//        console.log(jsonObject[i].length);
//
...
//            leerDatos.innerHTML = 'No results returned.';
//        } else {
//            let output = "";
//            
//            output += `
