...
<head>
    ...
    <link rel="stylesheet" href="../../front-css/loto/insertar.css">
</head>
<body>
    <?php require_once '../../sql/loto/header_nav.php'; ?>
    
    <form action="../../sql/loto/insertar.php" method="post" enctype="multipart/form-data">
...
<script src="../../show/loto/insertar.js"></script>
</body>
</html>