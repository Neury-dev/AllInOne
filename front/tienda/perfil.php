...
<head>
    ...
    <link rel="stylesheet" href="../../front-css/tienda/perfil.css">
<!--JavaScript-->
...
<section>
    ...
    <section class="n-contenedor" style="background-image: url('jeans.jpg')">
        <section class="n-contenido">
            <section>
                <img src="../../front-img/tienda/avatar2.png" alt="" loading="lazy">
            </section>
            <section>
...
<script src="../../show/tienda/adaptador/perfil.js" defer=""></script>
</body>
</html>
