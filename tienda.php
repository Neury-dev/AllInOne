...
<!--CSS-->
    ...
    <link rel="stylesheet" href="front-css/tienda/main.css">
    <link rel="stylesheet" href="front-css/tienda/article.css">
...
<section class="n-grid-area-2">
    <nav>
        ...
        <a href="front/tienda/perfil.php">Perfil</a> 
        <a href="front/tienda/carrito.php">Carrito</a>
        <a href="">Buscar</a>
    </nav>
</section>
<!--
...
<section class="n-grid-area-3">
    <main>
        <div class="n-diapositivas n-desvanecerse">
            <img src="front-img/tienda/diapositiva-1.jpg" alt="">
            <!--<p class="n-texto">Colección, Recién llegados, Los recién llegados</p>-->
        </div>
        <div class="n-diapositivas n-desvanecerse">
            <img src="front-img/tienda/diapositiva-2.jpg" alt="">
            <!--<p class="n-texto">Caption Two</p>-->
        </div>
        <div class="n-diapositivas n-desvanecerse">
            <img src="front-img/tienda/diapositiva-3.jpg" alt="">
            <!--<p class="n-texto">Caption Three</p>-->
        </div>
        <div class="n-diapositivas n-desvanecerse">
            <img src="front-img/tienda/diapositiva-4.jpg" alt="">
            <!--<p class="n-texto">Caption Text</p>-->
        </div>
        <div class="n-diapositivas n-desvanecerse">
            <img src="front-img/tienda/diapositiva-5.jpg" alt="">
            <!--<p class="n-texto">Caption Text</p>-->
        </div>
        <div class="n-diapositivas n-desvanecerse">
            <img src="front-img/tienda/diapositiva-6.jpg" alt="">
            <!--<p class="n-texto">Caption Text</p>-->
        </div>
...
<script src="show/tienda/diapositiva.js" async=""></script>
<script src="show/tienda/adaptador/articulos.js" async=""></script>
