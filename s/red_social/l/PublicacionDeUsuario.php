...
class PublicacionDeUsuario {
    ...
    publicada() {
        ...
        $this->sql = $GLOBALS["base"]->conexion->query("SELECT * FROM `Publicaciones` WHERE idUsuario = '" . $_SESSION["usuario"] . "' ORDER BY id DESC");
...
$publicacion = new PublicacionDeUsuario();
