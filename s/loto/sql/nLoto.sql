...
--
-- Servidor: localhost
-- Tiempo de generación: 08-04-2021 a las 13:43:53
...
INSERT INTO `nHistorial` (`nID`, `nFecha`, `nSorteo`, `nLoto`, `nLotoMas`, `nSuperMas`) VALUES
...
--
ALTER TABLE `nHistorial`
  MODIFY `nID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=394;
COMMIT;
